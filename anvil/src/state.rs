...
use smithay::{
    ...
    delegate_keyboard_shortcuts_inhibit, delegate_layer_shell,
    ...
    wayland::{
        ...
        input_method_v3::{InputMethodHandler as InputMethodHandlerV3, InputMethodManagerState as InputMethodManagerStateV3, PopupSurface as PopupSurfaceV3},
