...
impl PopupKind {
    ...
    fn parent(&self) -> Option<WlSurface> {
        match *self {
            ...
            PopupKind::InputMethodV3(ref t) => t.get_parent().map(|parent| parent.surface.clone()),
        }
    }
    ...
    pub fn geometry(&self) -> Rectangle<i32, Logical> {
        ...
        match *self {
            ...
            PopupKind::InputMethodV3(ref t) => t.get_parent().map(|parent| parent.location).unwrap_or_default(),
        }
    }
